  ...
  const TOOLS = [
    {
      ...
      unit: '文字のデジタル表現',
      title: '文字コードビューア',
      desc: '入れた文字が、コンピュータの中でどんな数になっているかを見る。Unicode・UTF-8・UTF-16・Shift_JIS を 16進数で並べて、バイト数もくらべられる。わざと文字化けさせることもできる。',
      feats: ['16進数で表示', '2進数も見る', 'バイト数くらべ', '文字化けを作る']
    },
    {
      subject: 'joho1',
      path: 'sound/',
  ...
  const SUBJECTS = [
    {
      ...
      label: '情報Ⅰ',
      path: 'joho1/',
      desc: 'デジタル化のしくみを、文字・音・色・画像で確かめる教材です。'
    },
    {
      key: 'joho2',
      label: '情報Ⅱ',
